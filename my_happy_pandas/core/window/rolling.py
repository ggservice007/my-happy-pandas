...
from my_happy_pandas._libs.tslibs import BaseOffset, to_offset
import my_happy_pandas._libs.window.aggregations as window_aggregations
from my_happy_pandas._typing import Axis, FrameOrSeries, Scalar
...
from my_happy_pandas.core.base import DataError, PandasObject, SelectionMixin, ShallowMixin
import my_happy_pandas.core.common as com
from my_happy_pandas.core.construction import extract_array
from my_happy_pandas.core.indexes.api import Index, MultiIndex, ensure_index
from my_happy_pandas.core.util.numba_ import NUMBA_FUNC_CACHE, maybe_use_numba
from my_happy_pandas.core.window.common import (
    WindowGroupByMixin,
    _doc_template,
    _flex_binary_moment,
    _shared_docs,
...
from my_happy_pandas.core.window.numba_ import generate_numba_apply_func
...
class _Window(PandasObject, ShallowMixin, SelectionMixin):
    ...
    def _wrap_results(self, results, blocks, obj, exclude=None) -> FrameOrSeries:
        ...
        """
        from my_happy_pandas import Series, concat
...
class _Rolling_and_Expanding(_Rolling):
    ...
    **kwargs
    ...
    pairwise : bool, default None
        ...
        Not relevant for :class:`~my_happy_pandas.Series`.
    **kwargs
        Unused.
