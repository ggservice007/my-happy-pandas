...
from my_happy_pandas.util._decorators import Appender, Substitution, doc

from my_happy_pandas.core.window.common import WindowGroupByMixin, _doc_template, _shared_docs
from my_happy_pandas.core.window.rolling import _Rolling_and_Expanding
