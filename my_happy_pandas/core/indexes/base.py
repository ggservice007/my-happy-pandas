...
import my_happy_pandas._libs.join as libjoin
from my_happy_pandas._libs.lib import is_datetime_array, no_default
from my_happy_pandas._libs.tslibs import OutOfBoundsDatetime, Timestamp
from my_happy_pandas._libs.tslibs.period import IncompatibleFrequency
from my_happy_pandas._libs.tslibs.timezones import tz_compare
from my_happy_pandas._typing import DtypeObj, Label
from my_happy_pandas.compat import set_function_name
from my_happy_pandas.compat.numpy import function as nv
from my_happy_pandas.errors import InvalidIndexError
from my_happy_pandas.util._decorators import Appender, Substitution, cache_readonly, doc

from my_happy_pandas.core.dtypes import concat as _concat
...
from my_happy_pandas.core.dtypes.concat import concat_compat
from my_happy_pandas.core.dtypes.generic import (
    ABCCategorical,
    ABCDataFrame,
    ABCDatetimeIndex,
    ABCMultiIndex,
...
from my_happy_pandas.core import ops
...
from my_happy_pandas.core.arrays.datetimes import tz_to_dtype, validate_tz_from_dtype
from my_happy_pandas.core.base import IndexOpsMixin, PandasObject
import my_happy_pandas.core.common as com
from my_happy_pandas.core.indexers import deprecate_ndim_indexing
from my_happy_pandas.core.indexes.frozen import FrozenList
import my_happy_pandas.core.missing as missing
from my_happy_pandas.core.ops import get_op_result_name
from my_happy_pandas.core.ops.invalid import make_invalid_op
from my_happy_pandas.core.sorting import ensure_key_mapped
from my_happy_pandas.core.strings import StringMethods
...
if TYPE_CHECKING:
    from my_happy_pandas import Series
...
def _new_Index(cls, d):
    ...
    if issubclass(cls, ABCPeriodIndex):
        from my_happy_pandas.core.indexes.period import _new_PeriodIndex
...
class Index(IndexOpsMixin, PandasObject):
    ...
    def __new__(
        ...
        from my_happy_pandas.core.indexes.range import RangeIndex
        ...
        # categorical
            ...
            from my_happy_pandas.core.indexes.category import CategoricalIndex
        ...
        # interval
            ...
            # Delay import for perf. https://github.com/pandas-dev/pandas/pull/31423
            from my_happy_pandas.core.indexes.interval import IntervalIndex
            ...
            # Delay import for perf. https://github.com/pandas-dev/pandas/pull/31423
            from my_happy_pandas import DatetimeIndex
            ...
            # Delay import for perf. https://github.com/pandas-dev/pandas/pull/31423
            from my_happy_pandas import TimedeltaIndex
            ...
            # Delay import for perf. https://github.com/pandas-dev/pandas/pull/31423
            from my_happy_pandas import PeriodIndex
        ...
        # index-like
            ...
            # Delay import for perf. https://github.com/pandas-dev/pandas/pull/31423
            from my_happy_pandas.core.indexes.numeric import (
                Float64Index,
                Int64Index,
                UInt64Index,
            )
            ...
            if tupleize_cols and is_list_like(data):
                ...
                if data and all(isinstance(e, tuple) for e in data):
                    ...
                    # 10697
                    from my_happy_pandas.core.indexes.multi import MultiIndex
    ...
    def _format_with_header(
        ...
        from my_happy_pandas.io.formats.format import format_array
    ...
    def _join_multi(self, other, how, return_indexers=True):
        from my_happy_pandas.core.indexes.multi import MultiIndex
        from my_happy_pandas.core.reshape.merge import _restore_dropped_levels_multijoin
    ...
    def _join_non_unique(self, other, how="left", return_indexers=False):
        from my_happy_pandas.core.reshape.merge import _get_join_indexers
    ...
    def array(self) -> ExtensionArray:
        ...
        if isinstance(array, np.ndarray):
            from my_happy_pandas.core.arrays.numpy_ import PandasArray
