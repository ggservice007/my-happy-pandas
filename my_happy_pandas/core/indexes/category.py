...
from my_happy_pandas._libs import index as libindex
...
from my_happy_pandas.core import accessor
from my_happy_pandas.core.algorithms import take_1d
from my_happy_pandas.core.arrays.categorical import Categorical, contains, recode_for_categories
...
from my_happy_pandas.core.indexes.base import Index, _index_shared_docs, maybe_extract_name
from my_happy_pandas.core.indexes.extension import ExtensionIndex, inherit_names
...
class CategoricalIndex(ExtensionIndex, accessor.PandasDelegate):
    ...
    def astype(self, dtype, copy=True):
        ...
        if is_interval_dtype(dtype):
            from my_happy_pandas import IntervalIndex
    ...
    def map(self, mapper):
        ...
        :class:`~my_happy_pandas.CategoricalIndex` which has the same order property as
        the original, otherwise an :class:`~my_happy_pandas.Index` is returned.
