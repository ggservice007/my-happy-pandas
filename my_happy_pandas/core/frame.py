...
from my_happy_pandas._libs import algos as libalgos, lib, properties
...
from my_happy_pandas.compat import PY37
...
from my_happy_pandas.util._decorators import (
    Appender,
    Substitution,
    deprecate_kwarg,
    doc,
...
from my_happy_pandas.util._validators import (
...
from my_happy_pandas.core import algorithms, common as com, nanops, ops
from my_happy_pandas.core.accessor import CachedAccessor
from my_happy_pandas.core.aggregation import reconstruct_func, relabel_result
from my_happy_pandas.core.arrays import Categorical, ExtensionArray
from my_happy_pandas.core.arrays.datetimelike import DatetimeLikeArrayMixin as DatetimeLikeArray
from my_happy_pandas.core.arrays.sparse import SparseFrameAccessor
from my_happy_pandas.core.construction import extract_array
from my_happy_pandas.core.generic import NDFrame, _shared_docs
from my_happy_pandas.core.indexes import base as ibase
from my_happy_pandas.core.indexes.api import Index, ensure_index, ensure_index_from_sequences
from my_happy_pandas.core.indexes.datetimes import DatetimeIndex
from my_happy_pandas.core.indexes.multi import MultiIndex, maybe_droplevels
from my_happy_pandas.core.indexes.period import PeriodIndex
from my_happy_pandas.core.indexing import check_bool_indexer, convert_to_index_sliceable
from my_happy_pandas.core.internals import BlockManager
from my_happy_pandas.core.internals.construction import (
    arrays_to_mgr,
...
from my_happy_pandas.core.reshape.melt import melt
from my_happy_pandas.core.series import Series
from my_happy_pandas.core.sorting import ensure_key_mapped

from my_happy_pandas.io.common import get_filepath_or_buffer
from my_happy_pandas.io.formats import console, format as fmt
from my_happy_pandas.io.formats.info import DataFrameInfo
import my_happy_pandas.plotting

if TYPE_CHECKING:
    from my_happy_pandas.core.groupby.generic import DataFrameGroupBy

    from my_happy_pandas.io.formats.style import Styler
...
class DataFrame(NDFrame):
    ...
    def to_string(
        ...
        2     3     6
        """
        from my_happy_pandas import option_context
    ...
    def to_gbq(
        ...
        """
        from my_happy_pandas.io import gbq
    ...
    def to_stata(
        ...
        if version == 114:
            ...
            from my_happy_pandas.io.stata import StataWriter as statawriter
        elif version == 117:
            # mypy: Name 'statawriter' already defined (possibly by an import)
            from my_happy_pandas.io.stata import StataWriter117 as statawriter  # type: ignore
        else:  # versions 118 and 119
            # mypy: Name 'statawriter' already defined (possibly by an import)
            from my_happy_pandas.io.stata import StataWriterUTF8 as statawriter  # type: ignore
    ...
    def to_feather(self, path, **kwargs) -> None:
        ...
        **kwargs :
            ...
            .. versionadded:: 1.1.0
        """
        from my_happy_pandas.io.feather_format import to_feather
    ...
    def to_parquet(
        ...
        **kwargs
        ...
        >>> content = f.read()
        """
        from my_happy_pandas.io.parquet import to_parquet
    ...
    def eval(self, expr, inplace=False, **kwargs):
        ...
        **kwargs
        ...
        4  5   2   7  3
        """
        from my_happy_pandas.core.computation.eval import eval as _eval
    ...
    def duplicated(
        ...
        dtype: bool
        """
        from my_happy_pandas._libs.hashtable import _SIZE_HINT_LIMIT, duplicated_int64

        from my_happy_pandas.core.sorting import get_group_index
    ...
    def sort_values(  # type: ignore[override] # NOQA # issue 27237
        ...
        if len(by) > 1:
            from my_happy_pandas.core.sorting import lexsort_indexer
            ...
            from my_happy_pandas.core.sorting import nargsort
...
"""
    ...
    def combine_first(self, other: "DataFrame") -> "DataFrame":
        ...
        2  NaN  3.0  1.0
        """
        import my_happy_pandas.core.computation.expressions as expressions
...
"""
    ...
    def pivot(self, index=None, columns=None, values=None) -> "DataFrame":
        from my_happy_pandas.core.reshape.pivot import pivot
    ...
    def pivot_table(
        ...
        from my_happy_pandas.core.reshape.pivot import pivot_table
    ...
    def stack(self, level=-1, dropna=True):
        ...
        **Dropping missing values**
        ...
        dog kg     NaN     2.0
            m      3.0     NaN
        """
        from my_happy_pandas.core.reshape.reshape import stack, stack_multiple
    ...
    def unstack(self, level=-1, fill_value=None):
        ...
        dtype: float64
        """
        from my_happy_pandas.core.reshape.reshape import unstack
    ...
    def apply(self, func, axis=0, raw=False, result_type=None, args=(), **kwds):
        ...
        **kwds
        ...
        2  1  2
        """
        from my_happy_pandas.core.apply import frame_apply
    ...
    def append(
        ...
        from my_happy_pandas.core.reshape.concat import concat
    ...
    def _join_compat(
        ...
        from my_happy_pandas.core.reshape.concat import concat
        from my_happy_pandas.core.reshape.merge import merge
    ...
    plot = CachedAccessor("plot", my_happy_pandas.plotting.PlotAccessor)
    hist = my_happy_pandas.plotting.hist_frame
    boxplot = my_happy_pandas.plotting.boxplot_frame
