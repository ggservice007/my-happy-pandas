...
from my_happy_pandas._libs.interval import Interval
from my_happy_pandas._libs.tslibs import NaT, Period, Timestamp, dtypes, timezones, to_offset
from my_happy_pandas._libs.tslibs.offsets import BaseOffset
from my_happy_pandas._typing import DtypeObj, Ordered

from my_happy_pandas.core.dtypes.base import ExtensionDtype, register_extension_dtype
from my_happy_pandas.core.dtypes.generic import ABCCategoricalIndex, ABCIndexClass
from my_happy_pandas.core.dtypes.inference import is_bool, is_list_like

if TYPE_CHECKING:
    import pyarrow  # noqa: F401

    from my_happy_pandas import Categorical  # noqa: F401
    from my_happy_pandas.core.arrays import (  # noqa: F401
        DatetimeArray,
        IntervalArray,
        PeriodArray,
    )
...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def _hash_categories(categories, ordered: Ordered = True) -> int:
        from my_happy_pandas.core.dtypes.common import DT64NS_DTYPE, is_datetime64tz_dtype

        from my_happy_pandas.core.util.hashing import (
    ...
    def construct_array_type(cls) -> Type["Categorical"]:
        ...
        type
        """
        from my_happy_pandas import Categorical  # noqa: F811
    ...
    def validate_categories(categories, fastpath: bool = False):
        ...
        categories : Index
        """
        from my_happy_pandas.core.indexes.base import Index
    ...
    def _is_boolean(self) -> bool:
        from my_happy_pandas.core.dtypes.common import is_bool_dtype

        return is_bool_dtype(self.categories)

    def _get_common_dtype(self, dtypes: List[DtypeObj]) -> Optional[DtypeObj]:
        from my_happy_pandas.core.arrays.sparse import SparseDtype
...
class DatetimeTZDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> Type["DatetimeArray"]:
        ...
        type
        """
        from my_happy_pandas.core.arrays import DatetimeArray  # noqa: F811
...
class PeriodDtype(dtypes.PeriodDtypeBase, PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> Type["PeriodArray"]:
        ...
        type
        """
        from my_happy_pandas.core.arrays import PeriodArray
    ...
    def __from_arrow__(
        ...
        from my_happy_pandas.core.arrays import PeriodArray
        from my_happy_pandas.core.arrays._arrow_utils import pyarrow_array_to_numpy_and_mask
...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> Type["IntervalArray"]:
        ...
        type
        """
        from my_happy_pandas.core.arrays import IntervalArray
    ...
    def __eq__(self, other: Any) -> bool:
        if isinstance(other, str):
            ...
            from my_happy_pandas.core.dtypes.common import is_dtype_equal
