...
from my_happy_pandas.core.computation.engines import _engines
from my_happy_pandas.core.computation.expr import Expr, _parsers
from my_happy_pandas.core.computation.parsing import tokenize_string
from my_happy_pandas.core.computation.scope import ensure_scope
...
def _check_engine(engine: Optional[str]) -> str:
    ...
    str
        Engine name.
    """
    from my_happy_pandas.core.computation.check import _NUMEXPR_INSTALLED
