...
from my_happy_pandas._libs.tslibs import Tick, Timestamp, to_offset
...
from my_happy_pandas.errors import AbstractMethodError, InvalidIndexError
...
from my_happy_pandas.core.dtypes.inference import is_hashable
from my_happy_pandas.core.dtypes.missing import isna, notna

import my_happy_pandas as pd
from my_happy_pandas.core import missing, nanops
import my_happy_pandas.core.algorithms as algos
from my_happy_pandas.core.base import PandasObject, SelectionMixin
import my_happy_pandas.core.common as com
from my_happy_pandas.core.construction import create_series_with_explicit_dtype
from my_happy_pandas.core.indexes.api import Index, MultiIndex, RangeIndex, ensure_index
from my_happy_pandas.core.indexes.datetimes import DatetimeIndex
from my_happy_pandas.core.indexes.period import Period, PeriodIndex
import my_happy_pandas.core.indexing as indexing
from my_happy_pandas.core.internals import BlockManager
from my_happy_pandas.core.missing import find_valid_index
from my_happy_pandas.core.ops import _align_method_FRAME
from my_happy_pandas.core.shared_docs import _shared_docs

from my_happy_pandas.io.formats import format as fmt
from my_happy_pandas.io.formats.format import DataFrameFormatter, format_percentiles
from my_happy_pandas.io.formats.printing import pprint_thing

if TYPE_CHECKING:
    from my_happy_pandas.core.resample import Resampler
    from my_happy_pandas.core.series import Series  # noqa: F401
...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def _get_index_resolvers(self) -> Dict[str, ABCSeries]:
        from my_happy_pandas.core.computation.parsing import clean_column_name
    ...
    def to_excel(
        ...
        from my_happy_pandas.io.formats.excel import ExcelFormatter
    ...
    def to_json(
        ...
        """
        from my_happy_pandas.io import json
    ...
    def to_hdf(
        ...
        >>> os.remove('data.h5')
        """
        from my_happy_pandas.io import pytables
    ...
    def to_sql(
        ...
        [(1,), (None,), (2,)]
        """
        from my_happy_pandas.io import sql
    ...
    def to_pickle(
        ...
        >>> os.remove("./dummy.pkl")
        """
        from my_happy_pandas.io.pickle import to_pickle
    ...
    def to_clipboard(
        ...
        **kwargs
        ...
        ... # 4,5,6
        """
        from my_happy_pandas.io import clipboards
    ...
    def to_csv(
        ...
        from my_happy_pandas.io.formats.csvs import CSVFormatter
    ...
    def interpolate(
        ...
        **kwargs
        ...
        Examples
        --------
        Filling in ``NaN`` in a :class:`~my_happy_pandas.Series` via linear
        interpolation.
    ...
    def asfreq(
        ...
        2000-01-01 00:03:00    3.0
        """
        from my_happy_pandas.core.resample import asfreq
    ...
    def resample(
        ...
        >>> from my_happy_pandas.tseries.frequencies import to_offset
        >>> loffset = '19min'
        ...
        Freq: 17T, dtype: int64
        """
        from my_happy_pandas.core.resample import get_resampler
    ...
    def _add_series_or_dataframe_operations(cls):
        ...
        """
        from my_happy_pandas.core.window import (
            Expanding,
