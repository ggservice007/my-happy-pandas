...
from my_happy_pandas.util._decorators import Appender, Substitution

from my_happy_pandas.core.dtypes.common import is_integer, is_list_like
...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    def _get_call_args(backend_name, data, args, kwargs):
        ...
        if backend_name == "my_happy_pandas.plotting._matplotlib":
    ...
    def __call__(self, *args, **kwargs):
        ...
        if plot_backend.__name__ != "my_happy_pandas.plotting._matplotlib":
...
def _get_plot_backend(backend=None):
    ...
    if backend == "matplotlib":
        ...
        try:
            import my_happy_pandas.plotting._matplotlib as module
        except ImportError:
            raise ImportError(
