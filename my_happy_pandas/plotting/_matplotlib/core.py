...
from my_happy_pandas.util._decorators import cache_readonly
...
from my_happy_pandas.plotting._matplotlib.compat import _mpl_ge_3_0_0
from my_happy_pandas.plotting._matplotlib.converter import register_pandas_matplotlib_converters
from my_happy_pandas.plotting._matplotlib.style import _get_standard_colors
from my_happy_pandas.plotting._matplotlib.tools import (
    _flatten,
    _get_all_lines,
    _get_xlim,
    _handle_shared_axes,
...
class LinePlot(MPLPlot):
    ...
    def __init__(self, data, **kwargs):
        from my_happy_pandas.plotting import plot_params
    ...
    def _use_dynamic_x(self):
        from my_happy_pandas.plotting._matplotlib.timeseries import _use_dynamic_x

        return _use_dynamic_x(self._get_ax(0), self.data)

    def _make_plot(self):
        if self._is_ts_plot():
            from my_happy_pandas.plotting._matplotlib.timeseries import _maybe_convert_index
    ...
    def _ts_plot(cls, ax, x, data, style=None, **kwds):
        from my_happy_pandas.plotting._matplotlib.timeseries import (
            _decorate_axes,
            _maybe_resample,
            format_dateaxis,
        )
